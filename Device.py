...
def __init__(self, device_id):
    ...
    if redis_client.exists(self.device_id) is 1:
        ...
        self.lattiude = redis_client.hget(device_id, 'lattitude').decode("utf-8")
        self.longitude = redis_client.hget(device_id, 'longitude').decode("utf-8")
        self.signal_strenght = redis_client.hget(device_id, 'signal_strength').decode("utf-8")
...
def createDevice(device_id, properties: json):
    if redis_client.exists(properties['MSISDN']) is 0:
        device_data = {
            ...
            'signal_strenght': properties['signal_strenght'],
